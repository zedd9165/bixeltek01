...
export default function TreatmentsSection({ onCtaClick }: TreatmentsSectionProps) {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute top-10 left-1/2 -translate-x-1/2 w-[650px] h-[350px] rounded-full bg-gradient-to-r from-blue-600/15 via-cyan-500/10 to-transparent blur-[140px]" />
      <div className="pointer-events-none absolute bottom-20 left-10 w-[450px] h-[450px] rounded-full bg-blue-600/10 blur-[130px]" />
      <div className="pointer-events-none absolute top-1/2 right-0 w-[500px] h-[500px] rounded-full bg-cyan-500/10 blur-[140px]" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-20">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/[0.04] border border-white/10 text-cyan-400 text-[11px] font-semibold tracking-[0.12em] uppercase mb-5 backdrop-blur-sm"
          >
          ...
          <motion.h2
            ...
            className="text-3xl sm:text-4xl md:text-6xl font-extrabold tracking-[-0.03em] text-white leading-[1.2] mb-6"
          >
            Don&apos;t Just Advertise Your Practice.{' '}
            <span className="block mt-2 bg-gradient-to-r from-blue-400 via-cyan-300 to-cyan-400 bg-clip-text text-transparent">
          ...
          <motion.p
            ...
            className="text-base sm:text-lg text-white/60 leading-relaxed font-normal"
          >
        ...
        <div className="space-y-6">
          ...
          <motion.div
            ...
            className="relative rounded-3xl p-6 sm:p-8 lg:p-10 bg-gradient-to-b from-white/[0.06] via-white/[0.03] to-white/[0.015] border border-blue-500/30 shadow-[0_24px_64px_rgba(0,0,0,0.45)] backdrop-blur-md overflow-hidden"
          >
            {/* Ambient inner card glow */}
            <div className="pointer-events-none absolute -top-24 -right-24 w-96 h-96 bg-blue-500/15 rounded-full blur-3xl" />
            ...
            <div className="relative grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-5 flex flex-col justify-between space-y-6">
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-2.5 mb-4">
                    <span className="text-xs font-mono font-bold tracking-widest text-cyan-400 bg-cyan-500/10 border border-cyan-500/20 px-2.5 py-1 rounded-md">
                      01
                    </span>
                    <span className="text-[11px] font-bold uppercase tracking-wider text-blue-300 bg-blue-500/10 border border-blue-500/25 px-3 py-1 rounded-md">
                      FEATURED CAMPAIGN
                    </span>
                    <span className="text-[11px] font-semibold uppercase tracking-wider text-white/50 bg-white/[0.04] border border-white/10 px-2.5 py-1 rounded-md">
                      HIGH-VALUE TREATMENT
                    </span>
                  </div>

                  {/* Headline */}
                  <h3 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-white tracking-tight leading-snug mb-3">
                    Dental Implants
                  </h3>

                  <div className="inline-flex items-center gap-2 text-xs font-semibold text-cyan-300 mb-4 bg-cyan-950/40 border border-cyan-500/20 px-3 py-1.5 rounded-lg">
                  ...
                  <div className="flex flex-wrap items-center gap-2 mb-6">
                    <span className="text-xs font-semibold uppercase tracking-wide bg-blue-600/20 text-blue-300 border border-blue-500/30 px-3 py-1 rounded-md">
                      HIGH VALUE
                    </span>
                    <span className="text-xs font-semibold uppercase tracking-wide bg-white/5 text-white/80 border border-white/10 px-3 py-1 rounded-md">
                      GOOGLE ADS
                    </span>
                  </div>
                </div>
                ...
                <div className="pt-4 border-t border-white/10 space-y-3">
                  <div>
                    <p className="text-xs font-mono uppercase tracking-wider text-white/40 mb-1.5">
                      ACQUISITION ARCHITECTURE
                    </p>
                    <p className="text-sm text-white/80 font-medium">
                      Search Intent → Targeted Ad → Focused Landing Page → Booked Consultation
                    </p>
                  </div>
                  <div>
                    <button
                      onClick={handleAction}
                      className="inline-flex items-center gap-2 text-xs sm:text-sm font-bold text-cyan-400 hover:text-cyan-300 transition-colors group cursor-pointer"
                    >
              ...
              <div className="lg:col-span-7">
                <div className="relative rounded-2xl bg-[#07090e]/95 border border-white/10 p-5 sm:p-6 lg:p-7 shadow-2xl">
                  {/* Mock Window Top Bar */}
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="relative p-3.5 sm:p-4 rounded-xl bg-white/[0.03] border border-white/10 transition-all hover:border-blue-500/30">
                      ...
                      <div className="flex items-center gap-3 bg-[#0d111c] border border-white/10 rounded-lg px-3.5 py-2.5">
                        <FaSearch className="text-cyan-400 flex-shrink-0" size={13} />
                    ...
                    <div className="relative p-3.5 sm:p-4 rounded-xl bg-white/[0.03] border border-white/10 transition-all hover:border-blue-500/30">
                      <div className="flex items-center justify-between text-[11px] font-mono text-white/40 uppercase tracking-wider mb-2">
                        <span>STAGE 03 • DEDICATED LANDING PAGE</span>
                        <span className="text-indigo-300">FOCUSED CRO</span>
                      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
            {SUPPORTING_TREATMENTS.slice(0, 6).map((item, idx) => (
              <motion.div
                ...
                whileHover={{ y: -3 }}
                onClick={handleAction}
                className="group relative rounded-2xl p-6 sm:p-7 bg-white/[0.03] border border-white/10 hover:border-blue-500/40 hover:bg-white/[0.05] transition-all duration-300 flex flex-col justify-between overflow-hidden cursor-pointer shadow-sm"
              >
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between gap-2 mb-3">
                    <span className="text-sm font-mono font-semibold text-white/30 group-hover:text-cyan-400 transition-colors">
                      {item.number}
                    </span>
                    <span className="text-[10px] font-semibold tracking-wider uppercase text-white/50 bg-white/[0.04] border border-white/10 px-2 py-0.5 rounded">
                      {item.intent}
                    </span>
                  </div>
                  ...
                  {/* Treatment Title */}
                  <h4 className="text-lg sm:text-xl font-bold text-white group-hover:text-cyan-300 transition-colors mb-3 tracking-tight">
                    {item.title}
                  </h4>
                ...
                <div>
                  ...
                  <div className="mb-4">
                    <div className="inline-flex items-center gap-2 bg-[#06080d] border border-white/10 rounded-md px-2.5 py-1.5 text-xs text-white/70 font-mono group-hover:border-cyan-500/30 transition-colors max-w-full truncate">
                      <FaSearch size={10} className="text-cyan-400 flex-shrink-0" />
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-white/[0.07]">
                    <div className="flex flex-wrap gap-1.5">
                      {item.tags.map((tag, tIdx) => (
                        <span
                          key={tIdx}
                          className="text-[10px] font-semibold uppercase tracking-wider text-white/60 bg-white/[0.04] border border-white/[0.08] px-2 py-0.5 rounded"
                        >
                          {tag}
                        </span>
                      ))}
                    ...
                    <FaArrowRight
                      size={12}
                      className="text-white/30 group-hover:text-cyan-400 group-hover:translate-x-1 transition-all duration-200 flex-shrink-0 ml-2"
                    />
                  </div>
                </div>
              </motion.div>
          ...
          {SUPPORTING_TREATMENTS[6] && (
            <motion.div
              ...
              whileHover={{ y: -3 }}
              onClick={handleAction}
              className="group relative rounded-2xl p-6 sm:p-8 bg-white/[0.03] border border-white/10 hover:border-blue-500/40 hover:bg-white/[0.05] transition-all duration-300 overflow-hidden cursor-pointer shadow-sm"
            >
              <div className="relative flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                <div className="max-w-2xl space-y-2">
                  <div className="flex flex-wrap items-center gap-2 mb-1">
                    ...
                    <span className="text-[10px] font-semibold tracking-wider uppercase text-teal-400 bg-teal-500/10 border border-teal-500/20 px-2 py-0.5 rounded">
                  ...
                  <h4 className="text-xl sm:text-2xl font-bold text-white group-hover:text-cyan-300 transition-colors tracking-tight">
                ...
                <div className="flex flex-col sm:flex-row md:flex-col lg:flex-row items-start md:items-end lg:items-center gap-3 flex-shrink-0">
                  <div className="inline-flex items-center gap-2 bg-[#06080d] border border-white/10 rounded-md px-3 py-1.5 text-xs text-white/70 font-mono">
                    <FaSearch size={10} className="text-cyan-400 flex-shrink-0" />
                    <span>&quot;{SUPPORTING_TREATMENTS[6].searchQuery}&quot;</span>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    {SUPPORTING_TREATMENTS[6].tags.map((tag, tIdx) => (
                      <span
                        key={tIdx}
                        className="text-[10px] font-semibold uppercase tracking-wider text-white/60 bg-white/[0.04] border border-white/[0.08] px-2.5 py-1 rounded"
                      >
                        {tag}
                      </span>
                    ))}
        ...
        >
          ...
          <div className="space-y-1.5 mb-8">
            <p className="text-xl sm:text-2xl md:text-4xl font-bold text-white tracking-tight">
              More Treatment Searches.
            </p>
            <p className="text-xl sm:text-2xl md:text-4xl font-bold text-white tracking-tight">
              More Qualified Enquiries.
            </p>
            <p className="text-xl sm:text-2xl md:text-4xl font-extrabold bg-gradient-to-r from-blue-400 via-cyan-300 to-cyan-400 bg-clip-text text-transparent tracking-tight">
          ...
          <p className="text-xs sm:text-sm text-white/40 tracking-wide font-medium">
            Google Ads + Meta Ads • Treatment-Specific Campaigns • Conversion Tracking
          </p>
        </motion.div>
      </div>
