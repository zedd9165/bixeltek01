...
import { valueProps } from "@/data/whatsappEcommerce";
import whatsapp from '@/assets/why-whatsapp.png'

export default function ValueProps() {
  return (
    <section className="bg-black py-16 sm:py-24 overflow-hidden px-6">
      <div className="mx-auto grid md:max-w-[90%] items-center gap-12 lg:gap-16 lg:grid-cols-2">
        
        {/* Left Side: Clean Image with Bixeltek-Style Gradient Border */}
        ...
        <div className="flex flex-col items-start z-10">
          ...
          {/* Eyebrow */}
          <span className="text-green-400 font-bold tracking-wide uppercase text-sm mb-4">
            {valueProps.eyebrow}
          </span>
